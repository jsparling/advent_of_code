class Day9
  class << self
    ...
    attr_accessor :stack, :total_groups, :current_group, :score, :garbage_count
    ...
    def calc(input)
      ...
      puts input
      puts "score: #{@score}"
      puts "garbage: #{@garbage_count}"
      # puts "total groups: #{@total_groups}"
    end

    def add_group_one(element)
      ...
      if element == ","
        ...
        # this is garbage
        stack.pop
      elsif element == "{" && ( stack.last == "{" || stack.empty? )
        @current_group += 1
        stack << element
      elsif element == "}" && stack.last == "{"
        stack.pop
